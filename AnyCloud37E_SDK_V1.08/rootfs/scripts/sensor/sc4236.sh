...
#    if test ! -f /etc/config/isp_sc4236_mipi_2lane.conf ; then
    if test ! -f /etc/config/isp_sc4236_mipi_2lane_h3b.conf ; then
        rm /etc/config/isp_*.conf
#        cp /etc/isp_sc4236_mipi_2lane.conf /etc/config/
        cp /etc/isp_sc4236_mipi_2lane_h3b.conf /etc/config/
    fi
}
