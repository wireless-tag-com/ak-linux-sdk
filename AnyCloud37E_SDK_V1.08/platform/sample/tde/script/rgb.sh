...
pic_src=./aklogo.600.165.rgb                                                    #源图文件名
pic_bg=./desert.1024.600.rgb                                                    #背景图文件名
format="--format-s 1 --format-bg 1 --format-out 1"                              #源图 背景图 屏幕格式
file="--file-s $pic_src --file-bg $pic_bg"                                      #文件名称
rect_bg="--rect-bg 1024,600,0,0,1024,600"                                       #背景图坐标

rect_s="--rect-s 600,165,0,0,600,165"                                           #源图坐标
rect_t="--rect-t 212,218,600,165"                                               #贴图到屏幕坐标,屏幕宽高由sample获取
rect_t_rotate="--rect-t 430,0,165,600"                                          #旋转贴图到屏幕坐标
rect_t_scale="--rect-t 62,150,900,300"                                          #拉伸贴图到屏幕坐标
