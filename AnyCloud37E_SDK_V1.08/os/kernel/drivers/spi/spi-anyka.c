				    ...
				    struct spi_transfer *t)
{
...
#if (defined(CONFIG_MACH_AK37D) || defined(CONFIG_MACH_AK37E) || defined(CONFIG_MACH_AK3918AV100) || defined(CONFIG_MACH_AK3918EV300L)) && !defined(CONFIG_MACH_AK3918AV100_FPGA)
    int rc;
#endif
    ...
    if((spi->master->bus_num == 0) && (clk_get_rate(hw->bus_clk) != typical_hz)){
        rc = ak_spi_set_clk(spi, typical_hz);
        if (rc)
            return rc;
    }
#endif
